...
class ElasticRateControlManipulation(Manipulation):
    ...
    def manipulate(self):
        ...
        #accumulate imput
        #self._new_mat = avango.gua.make_trans_mat(_x,_y,_z)*avango.gua.make_rot_mat(_rx,1,0,0)*avango.gua.make_rot_mat(_ry,0,1,0)*avango.gua.make_rot_mat(_rz, 0,0,1)
